    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Packaging', 'Packaging'), ('processing', 'Processing'), ('dispatching', 'Dispatching'), ('shipping', 'Shipping'), ('delivery', 'Delivery')], default='processing', max_length=30)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_type', models.CharField(choices=[('standard_delivery', 'Standard delivery'), ('express_delivery', 'Express delivery'), ('international_delivery', 'International delivery'), ('in_store_pick_up', 'In-Store Pickup')], default='in_store_pick_up', max_length=30)),
                ('shipping_type', models.CharField(choices=[('postal_service', 'Postal Service'), ('courier_services', 'Couriers Services')], default='postal_service', max_length=30)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=product.models.ad.product_ad_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.TextField()),
                ('banner', models.ImageField(upload_to=product.models.category.product_category_directory_path)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.TextField()),
                ('discount_percent', models.DecimalField(decimal_places=2, max_digits=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('prom_type', models.CharField(choices=[('discount', 'Discount'), ('coupon_code', 'Coupon Code'), ('free_shipping', 'Free Shipping'), ('flash_sale', 'Flash Sale')], default='discount', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('review', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_review_sessions', to='product.productreview')),
            ],
            options={
